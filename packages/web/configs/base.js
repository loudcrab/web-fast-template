...
module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/keyword-spacing':
      baseStyleRules['keyword-spacing'],
    ...
    '@typescript-eslint/no-redeclare':
      baseBestPracticesRules['no-redeclare'],
    ...
    '@typescript-eslint/space-infix-ops':
      baseStyleRules['space-infix-ops'],
